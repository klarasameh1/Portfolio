          ...
          children: [
            ...
            const Text(
              ...
              "I’ve worked on projects ranging from personal portfolio to task management app and mini shopping app, "
                  "\npracticing state management with Provider\n I also pay close attention to UI/UX principles to make applications both functional and beautiful"
                  '\nMy goal is to grow as a Flutter developer by contributing to impactful projects while continuously learning and improving my craft.',
              style: TextStyle(
                fontSize: 22,
                color: Colors.white,
                height: 1.5,
